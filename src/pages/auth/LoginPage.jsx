    ...
    <div className='container my-5'>
      <div className='row justify-content-center'>      
        <div className='border col-lg-4 col-md-6 col-12 py-4'>
            ...
            <form className="p-5"  onSubmit={handleSubmit(enviar)} >              
              <input className='w-100 py-1 my-2 px-2 opacity-50' type="text" placeholder='Email' {...register('email')}/>
              <input className= 'w-100 py-1 my-2 px-2 opacity-50' type="password" placeholder='Contraseña' {...register('password')}/>
