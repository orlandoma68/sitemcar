            ...
            <div className="container">
                <div className="row g-4">
                    ...
                    <div className="col-lg-2 col-md-6">
                        ...
                        <ul className="list-unstyled">
                            <li className="mb-2"><Link to="#" className="footer-link text-decoration-none">compra venta de productos</Link></li>
                            <li className="mb-2"><Link to="#" className="footer-link text-decoration-none">logistica de Distribucion</Link></li>
